...
VALUES (1, 'Demo Workspace', 'demo', 'ACTIVE', NOW(), NOW())
...
VALUES
  (1, 1, 'Rahul Sharma', 'rahul.sharma@example.com', '+91-98765-10001', 'Nimbus Retail', 'HIGH_VALUE', NULL, NOW(), NOW()),
  (2, 1, 'Priya Menon', 'priya.menon@example.com', '+91-98765-10002', 'CloudCart India', 'PREMIUM', NULL, NOW(), NOW()),
  (3, 1, 'Aisha Khan', 'aisha.khan@example.com', '+91-98765-10003', 'GreenLine Logistics', 'AT_RISK', NULL, NOW(), NOW()),
  (4, 1, 'Vikram Patel', 'vikram.patel@example.com', '+91-98765-10004', 'Patel Electronics', 'NORMAL', NULL, NOW(), NOW()),
  (5, 1, 'Neha Gupta', 'neha.gupta@example.com', '+91-98765-10005', 'BrightDesk Services', 'PREMIUM', NULL, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (1, 1, 'Payment deducted twice', 'My payment was deducted twice and I need a refund urgently.', 'REFUND', 'HIGH', 'NEGATIVE', 'Billing Support', 'OPEN', NULL, NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days'),
  (1, 1, 'Invoice copy required', 'Please send the latest invoice copy for our finance team.', 'BILLING', 'LOW', 'NEUTRAL', 'Billing Support', 'RESOLVED', NULL, NOW() - INTERVAL '25 days', NOW() - INTERVAL '20 days'),
  (1, 2, 'Login error after password reset', 'I cannot login after resetting my password. The app shows an error.', 'TECHNICAL', 'MEDIUM', 'NEGATIVE', 'Technical Support', 'IN_PROGRESS', NULL, NOW() - INTERVAL '3 days', NOW() - INTERVAL '2 days'),
  (1, 2, 'Positive feedback', 'The new dashboard is great and our team loves it.', 'GENERAL', 'LOW', 'POSITIVE', 'General Support', 'CLOSED', NULL, NOW() - INTERVAL '16 days', NOW() - INTERVAL '14 days'),
  (1, 3, 'Delivery delayed', 'Shipment is delayed and tracking has not updated for a week.', 'DELIVERY', 'MEDIUM', 'NEGATIVE', 'Logistics Support', 'OPEN', NULL, NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days'),
  (1, 3, 'Charged but order failed', 'The order failed but my card was charged. This is very frustrating.', 'BILLING', 'HIGH', 'NEGATIVE', 'Billing Support', 'OPEN', NULL, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days'),
  (1, 4, 'Update account email', 'Please help me update my account email address.', 'ACCOUNT', 'MEDIUM', 'NEUTRAL', 'Account Support', 'OPEN', NULL, NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
  (1, 5, 'App crash during checkout', 'The mobile app crashes during checkout and blocks purchases.', 'TECHNICAL', 'HIGH', 'NEGATIVE', 'Technical Support', 'IN_PROGRESS', NULL, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days');
